...
public class MainController {
	...
	public ModelAndView searchProducts(@RequestParam String partName, @RequestParam String shopName,
			@RequestParam int shopNumber) {
		researcherControllerService.setResearcher(partName, shopName, shopNumber,
				this.mainControllerService.getPartSearched());
